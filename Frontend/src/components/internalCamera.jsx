...
export default function InternalCamera() {
  // --- State and Refs ---
  ...
  /**
   * Initializes the camera stream when the component mounts.
   */
  useEffect(() => {
  ...
  /**
   * Sets up an interval to send frames when recording is active.
   */
  // --- Core Functions ---

  /**
   * Captures a frame from the video stream, converts it to JPEG, and sends it to the server.
   */
